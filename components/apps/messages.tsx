...
const conversations = [
  { id: 1, name: "Sarah Johnson", lastMessage: "See you tomorrow!", time: "2:30 PM", unread: 2, avatar: "SJ" },
  { id: 2, name: "Work Team", lastMessage: "Meeting at 3 PM", time: "1:15 PM", unread: 0, avatar: "WT" },
  { id: 3, name: "Mom", lastMessage: "Love you!", time: "Yesterday", unread: 0, avatar: "M" },
  { id: 4, name: "Alex Chen", lastMessage: "Thanks for the help", time: "Monday", unread: 0, avatar: "AC" },
  { id: 5, name: "Emily Davis", lastMessage: "Sounds good!", time: "Sunday", unread: 0, avatar: "ED" },
]
...
const messagesByConversation: Record<number, Array<{ id: number; text: string; sent: boolean; time: string }>> = {
  ...
  3: [
    ...
    { id: 3, text: "Love you!", sent: false, time: "Yesterday" },
  ],
      ...
      <div className="w-full md:w-80 border-r border-gray-200 flex flex-col">
        ...
        <div className="flex-1 overflow-auto">
          {conversations.map((conv) => (
            ...
            >
              <div className="flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-br from-blue-400 to-sky-600 text-sm font-semibold text-white">
                {conv.avatar}
              </div>
