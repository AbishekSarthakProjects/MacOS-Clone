...
export function Terminal() {
  const [history, setHistory] = useState<string[]>([
    ...
    "Welcome to Pineapple OS Terminal",
    "",
  ])
...
drwx------  2 developer  staff    64 Dec 11 16:00 Videos`
      ...
      case "neofetch":
        output = `
                  ...
                  ####                   ----------------
                 ###                     OS: Pineapple OS 1.0
         #######    #######              Host: PineappleBook Pro (16-inch, 2026)
      ...
      #####################              DE: Aqua
       ######################            WM: Quartz Compositor
        ####################             Terminal: Terminal.app
          ################               CPU: Pineapple P1 Pro
             ####     ####                GPU: Pineapple P1 Pro
    ...
    setHistory([...history, `developer@pineapple ~ % ${cmd}`, output])
  }
  ...
  return (
    <div
      ref={terminalRef}
      className="h-full cursor-text overflow-auto bg-[#050607] p-4 font-mono text-xs text-green-400 md:text-sm"
    ...
    >
      ...
      <form onSubmit={handleSubmit} className="flex items-center gap-2 flex-wrap">
        <span className="text-blue-400">developer@pineapple</span>
